...
2. We will start support for FP8 data types with conversion-only instructions. Probably these will be convertion to/from 16-bit floating-point types from/to 8-bit floating-point types. We will focus on the more popular ML formats (E5M2 and E4M3), and not worry about block formats (e.g., MX) yet. 
