...
| major (7 bits) | vd (7 bits) | variant (3 bits) | vs1 (7 bits) | vs2 (7 bits) | vm (7 bits) | function (6 bits) | polarity (1 bit) | type (6 bits) | LMUL (3 bits) | vtma (2 bits) | vrnd (2 bits) |
|----------------|-------------|------------------|--------------|--------------|-------------|-------------------|------------------|---------------|---------------|---------------|---------------|          
| XXXX           |  0-127      | 0-7              | 0-127        | 0-127        | 0-127       | 0-63              | 0-1              | 0-63          | 0-7           | 0-3           | 0-3           |
